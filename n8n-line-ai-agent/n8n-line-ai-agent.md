...
4. ตั้งค่า LINE Flex Message JSON
...
<aside class="negative">
<strong>Note:</strong> ใน Codelab นี้ เราจะใช้ LINE Flex Message ที่เตรียมไว้ด้านล่าง โดยไม่ได้ใช้ Template ที่ Flex Message Simulator เตรียมไว้ให้
</aside>
...
4.1. **Rename node:** ตั้งชื่อ node เป็น `Send LINE Flex Message` (เพื่อให้เข้าใจง่ายว่า node นี้ทำหน้าที่อะไร)
4.2. **Alt Text:** ใส่ข้อความที่จะแสดงใน Notification เมื่อมีข้อความเข้า เช่น `เมนูอาหารแนะนำ`
4.3. **LINE Flex Message JSON:** นำโค้ด JSON ที่เตรียมไว้ด้านล่างมาวางลงในช่องนี้
