...
- ปรับแต่ง AI: เทคนิคการเขียนคำสั่ง (System Message) ให้ AI เข้าใจบริบทและตอบโจทย์ธุรกิจ
...
3. **System Message:** คำสั่งกำกับดูแลเพื่อกำหนดพฤติกรรมของ Agent
...
### เจาะลึก System Message
**System Message** (หรือ Instruction Prompt) คือส่วนประกอบที่สำคัญที่สุดในการกำหนดบุคลิกและการทำงานของ AI Agent เปรียบเสมือนชุดคำสั่งที่ระบุขอบเขตความรับผิดชอบ เพื่อให้ LLM ทำงานได้ตรงตามวัตถุประสงค์
...
4. แก้ไข System Message ให้เรียกใช้งาน Tools
...
* ไปที่โหนด **AI Agent**
* คลิกที่เครื่องหมาย **`+`** ในส่วนของการเชื่อมต่อ **Tools**
* ค้นหาคำว่า `LINE Messaging Tool` และเลือก **"Line Messaging Tool"** (สังเกตคำอธิบาย: *Interact with the Line Messaging API*)
...
เพื่อให้ AI Agent รู้ว่าควรเรียกใช้ Tool (Send LINE Flex Message) เมื่อไหร่ เราต้องเพิ่มคำสั่งใน System Message

* ไปที่ node **AI Agent**
* ในส่วนของ **System Message**  ให้เพิ่มคำสั่งเกี่ยวกับการใช้งาน Tool:
...
## ปรับปรุง System Message ให้ Agent ตอบได้ตามโจทย์ธุรกิจ
Duration: 0:5:00

![n8n Test Chat](images/10.1.png)

เนื่องจากในก่อนหน้านี้ AI Chatbot ของเรายังเป็นเพียงโมเดลภาษาทั่วไป ซึ่งอาจตอบคำถามกว้างๆ และยังไม่ตรงกับบริบทของธุรกิจร้านอาหารของเรา เพื่อให้บอททำงานได้สมบูรณ์แบบ เราจึงจำเป็นต้องแก้ไข **System Message** หรือ **Instruction** เพื่อกำหนดบทบาท (Persona) และขอบเขตการทำงานให้ชัดเจน (Objetives)

### ขั้นตอนทั้งหมด
1. แก้ไข System Message โดยใช้ ตัวอย่าง Prompt สำหรับร้านอาหาร
