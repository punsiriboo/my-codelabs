...
<aside class="positive">
<strong>Note:</strong> คุณสามารถใช้งาน n8n ได้ทั้งแบบ **n8n Cloud** (บริการแบบ paid) และ **Self-hosted** (ฟรี) ใน Codelab นี้เราจะใช้ Self-hosted บน Render
</aside>
...
### ความสามารถเสริม: Tool Calling (Function Calling) 
